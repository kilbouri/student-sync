...
struct StreamParamsMessage {
	long frameRate;
	ScreenResolution resolution;

	static std::optional<StreamParamsMessage> FromNetworkMessage(const NetworkMessage& netMessage) noexcept {
